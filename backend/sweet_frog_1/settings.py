"""
Django settings for sweet_frog_1 project.
...
ROOT_URLCONF = 'sweet_frog_1.urls'
...
WSGI_APPLICATION = 'sweet_frog_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Sweet Frog Support <support@sweet-frog-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sweet_frog_1 API",
    "DESCRIPTION": "API documentation for sweet_frog_1 App",
    "VERSION": "v1",
}
